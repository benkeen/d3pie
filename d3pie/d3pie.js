 ...
 * @fork https://github.com/akhaneev/d3pie
 */

import d3 from "tf-libs/js/extensions/extension-d3";
    ...
    positionLabelElements: function (pie, section, sectionDisplayType) {
        ...
        switch (sectionDisplayType) {
            ...
            case "value-percentage":
                d3.selectAll("." + pie.cssPrefix + "segmentValue-" + section)
                    .attr("dx", function (d, i) {
                        return (dims[i].percentage.width / 2) - (dims[i].value.width / 2);
                    })
                    .attr("dy", function (d, i) {
                        return -dims[i].percentage.height / 2;
                    });
                d3.selectAll("." + pie.cssPrefix + "segmentPercentage-" + section)
                    .attr("dy", function (d, i) {
                        return dims[i].percentage.height / 2;
